...
<body>
    ...
    $log = new Slayall;
    if ($roleName = "Staff") {
        $logs = $log->getAllLogsStaff($roleName);
    }
    if ($roleName = "Manager") {
        $logs = $log->getAllLogsStaff($roleName);
    }
                            ...
                            <tbody>
                                <?php foreach ($logs as $get) { ?>
                                    <tr>
                                        ...
                                        <td><?php echo $get['staff_fname'] . " " . $get['staff_mname'] . " " . $get['staff_lname']; ?></td>
                                        <td><?php echo $get['staff_address']; ?></td>
                                        <td><?php echo $get['staff_contact_num']; ?></td>
                                        <td><?php echo $get['staff_email']; ?></td>
