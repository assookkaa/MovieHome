...
<body>
    ...
    if (isset($_POST['Delete'])) {
        ...
        $confirm = $delete->deleteRoom($roomId);
        if ($confirm) {
            echo 'Movie deleted';
        }
    }
    ...
    ?>
    <a href="addroom.php">
        <button style="padding:2rem; font-size: 30px; font-weight: bold;">Add a Room</button>
    </a>
    <div class="movie-list">
        <?php foreach ($view as $room) { ?>
            <div class="movie">
                <img src='pictures/rooms/<?php echo $room['room_image'] ?>' style="width:800px;" alt="Movie 1">
                <h2>Title: <?php echo $room['room_number']; ?></h2>
                <p style="padding: 7px;">
                    <span style="font-weight: bold;">Capacity: </span><span><?php echo $room['room_capacity']; ?></span>
                </p>
                <a href="editroom.php?room_id=<?php echo $room['room_id']; ?>">
